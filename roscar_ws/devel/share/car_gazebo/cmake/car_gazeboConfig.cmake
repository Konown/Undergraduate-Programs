...
if("TRUE" STREQUAL "TRUE")
  set(car_gazebo_SOURCE_PREFIX /home/known/bachlor_project/roscar_ws/src/car_gazebo)
  set(car_gazebo_DEVEL_PREFIX /home/known/bachlor_project/roscar_ws/devel)
  ...
  set(car_gazebo_INSTALL_PREFIX /home/known/bachlor_project/roscar_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/known/bachlor_project/roscar_ws/src/car_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT car_gazebo_NUM_DUMMY_TARGETS)
      set(car_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::car_gazebo::wrapped-linker-option${car_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR car_gazebo_NUM_DUMMY_TARGETS "${car_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::car_gazebo::wrapped-linker-option${car_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND car_gazebo_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(car_gazebo_EXPORTED_TARGETS ${${car_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
